...
public class SimpleGui extends JFrame
{
    ...
    final JRadioButton radio1 = new JRadioButton("Select this");
    final JRadioButton radio2 = new JRadioButton("Select that");
    private final JCheckBox check = new JCheckBox("check", true);
